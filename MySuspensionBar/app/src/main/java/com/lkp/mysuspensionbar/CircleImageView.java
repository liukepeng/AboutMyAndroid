...
/**
 * Created by liuKepeng on 2016/11/9. 设置图片的时候要用android:src=
 */
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBitmapWidth = typedArray.getDimensionPixelSize(R.styleable.CircleImageView_civ_border_width,DEFAULT_BORDER_WIDTH);
        ...
        mFillColor = typedArray.getColor(R.styleable.CircleImageView_civ_fill_color,DEFAULT_FILL_COLOR);
